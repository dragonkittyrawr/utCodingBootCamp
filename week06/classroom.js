...
var Student = require("./classroom.js");



var Class = function(students, count, professor, room) {
  this.students = [];
  this.count = 0;
  this.professor = professor;
  this.room = room;
  this.addStudent = function(name, favSubject, gpa) {
    this.studentsArr.push(new Student(name, favSubject, gpa));
    this.count = studentsArr.length;
  };
};
